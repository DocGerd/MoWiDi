...
public class HTTPSocket {
    ...
    public HTTPSocket(final Socket socket) {
        setSocket(socket);
        open();
    }

    public HTTPSocket(final HTTPSocket socket) {
    ...
    //	post
    ////////////////////////////////////////////////
    private boolean post(final HTTPResponse httpRes, final byte content[], final long contentOffset, final long contentLength, final boolean isOnlyHeader) {
    ...
    public boolean post(final HTTPResponse httpRes, final long contentOffset, final long contentLength, final boolean isOnlyHeader) {
