 ...
 * JaxpParser.
 */
public final class JaxpParser extends Parser {
     ...
     * @return the node
     */
    public org.cybergarage.xml.Node parse(final org.cybergarage.xml.Node parentNode,
            final org.w3c.dom.Node domNode, final int rank) {
...
//          + domNodeType + ", attrs = " + arrrsLen);
     ...
     * @return the node
     */
    public org.cybergarage.xml.Node parse(final org.cybergarage.xml.Node parentNode, final org.w3c.dom.Node domNode) {
     ...
     */
    @Override
    public Node parse(final InputStream inStream) throws ParserException {
