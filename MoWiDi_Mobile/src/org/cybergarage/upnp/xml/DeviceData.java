...
public class DeviceData extends NodeData {
    ...
    public void setDescriptionURI(final String descriptionURI) {
    ...
    public void setLeaseTime(final int val) {
        leaseTime = val;
    }
    ////////////////////////////////////////////////
    //	HTTPServer
    ...
    public void setHTTPBindAddress(final InetAddress[] inets) {
     ...
     * @since 1.8
     */
    public void setSSDPPort(final int port) {
        this.ssdpPort = port;
    }
     ...
     * @since 1.8
     */
    public void setSSDPBindAddress(final InetAddress[] inets) {
     ...
     * @since 1.8
     */
    public void setMulticastIPv4Address(final String ip) {
     ...
     * @since 1.8
     */
    public void setMulticastIPv6Address(final String ip) {
    ...
    public void setAdvertiser(final Advertiser adv) {
        advertiser = adv;
    }
