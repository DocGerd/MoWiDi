...
public class SSDPSearchResponseSocketList extends Vector<SSDPSearchResponseSocket> {
    ...
    private static final long serialVersionUID = 8798556861311089600L;
    ...
    /**
     *
     * @param binds The host to bind.Use <tt>null</tt> for the default behaviour
     */
    public SSDPSearchResponseSocketList(final InetAddress[] binds) {
        this.binds = binds;
    }
    ...
    //	ControlPoint
    ////////////////////////////////////////////////
    public void setControlPoint(final ControlPoint ctrlPoint) {
        int nSockets = size();
    ...
    //	get
    ////////////////////////////////////////////////
    public SSDPSearchResponseSocket getSSDPSearchResponseSocket(final int n) {
        return get(n);
    }
    ...
    //	Methods
    ////////////////////////////////////////////////
    public boolean post(final SSDPSearchRequest req) {
        boolean ret = true;
        int nSockets = size();
        for (int n = 0; n < nSockets; n++) {
            SSDPSearchResponseSocket sock = getSSDPSearchResponseSocket(n);
