...
public class SSDPSearchSocketList extends Vector<SSDPSearchSocket> {
    ...
    private static final long serialVersionUID = -5124643219968245080L;
     ...
     */
    public SSDPSearchSocketList(final InetAddress[] binds) {
        this.binds = binds;
    }
     ...
     * @since 1.8
     */
    public SSDPSearchSocketList(final InetAddress[] binds, final int port, final String multicastIPv4, final String multicastIPv6) {
        this.binds = binds;
        this.port = port;
    ...
    //	Methods
    ////////////////////////////////////////////////
    public SSDPSearchSocket getSSDPSearchSocket(final int n) {
        return get(n);
    }
