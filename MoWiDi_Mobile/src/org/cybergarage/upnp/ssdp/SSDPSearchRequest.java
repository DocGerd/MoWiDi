...
public class SSDPSearchRequest extends SSDPRequest {
    ...
    public SSDPSearchRequest(final String serachTarget, final int mx) {
    ...
    public SSDPSearchRequest(final String serachTarget) {
    ...
    //	HOST
    ////////////////////////////////////////////////
    public void setLocalAddress(final String bindAddr) {
