...
public class SSDPSearchSocket extends HTTPMUSocket implements Runnable {
     ...
     * @since 1.8
     */
    public SSDPSearchSocket(final String bindAddr, final int port, final String multicast) {
     ...
     * @since 1.8
     */
    public SSDPSearchSocket(final InetAddress bindAddr) {
    ...
    //	Constructor
    ////////////////////////////////////////////////
    public boolean open(final Inet4Address bindAddr) {
        useIPv6Address = false;
        return open(SSDP.ADDRESS, SSDP.PORT, bindAddr);
    }

    public boolean open(final Inet6Address bindAddr) {
        useIPv6Address = true;
        return open(SSDP.getIPv6Address(), SSDP.PORT, bindAddr);
    }

    public boolean open(final String bind, final String multicast) {
     ...
     */
    public boolean open(final String bindAddr) {
    ...
    public void performSearchListener(final SSDPPacket ssdpPacket) {
