...
public class SSDPSearchResponseSocket extends HTTPUSocket implements Runnable {
    ...
    public SSDPSearchResponseSocket(final String bindAddr, final int port) {
        super(bindAddr, port);
        setControlPoint(null);
    }
    ////////////////////////////////////////////////
    ...
    public void setControlPoint(final ControlPoint ctrlp) {
    ...
    //	post
    ////////////////////////////////////////////////
    public boolean post(final String addr, final int port, final SSDPSearchResponse res) {
    ...
    //	post
    ////////////////////////////////////////////////
    public boolean post(final String addr, final int port, final SSDPSearchRequest req) {
