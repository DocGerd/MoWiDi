...
public class FuseGetattr extends FuseFtype implements FuseGetattrSetter, FuseStatConstants {
    ...
    private static final long serialVersionUID = -8102655452843899354L;
    public long inode;
    ...
    protected boolean appendAttributes(final StringBuilder buff, final boolean isPrefixed) {
        ...
        buff.append("inode=").append(inode).append(", nlink=").
                append(nlink).append(", uid=").append(uid).append(", gid=").
                append(gid).append(", rdev=").append(rdev).append(", size=").
                append(size).append(", blocks=").append(blocks).append(", atime=").
                append(atime).append(", mtime=").append(mtime).append(", ctime=").append(ctime);
