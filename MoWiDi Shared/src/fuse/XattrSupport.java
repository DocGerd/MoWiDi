 ...
 */
public interface XattrSupport extends Serializable {
    // bits passed in 'flags' parameter to setxattr() method

    int XATTR_CREATE = 0x1;        /* set value, fail if attr already exists */

    int XATTR_REPLACE = 0x2;       /* set value, fail if attr does not exist */
     ...
     */
    int getxattrsize(String path, String name, FuseSizeSetter sizeSetter) throws FuseException;
     ...
     */
    int getxattr(String path, String name, ByteBuffer dst) throws FuseException, BufferOverflowException;
     ...
     * @throws FuseException an alternative to returning errno is to throw this exception with errno initialized
     */
    int listxattr(String path, XattrLister lister) throws FuseException;
     ...
     * @throws FuseException an alternative to returning errno is to throw this exception with errno initialized
     */
    int setxattr(String path, String name, ByteBuffer value, int flags) throws FuseException;
     ...
     * @throws FuseException an alternative to returning errno is to throw this exception with errno initialized
     */
    int removexattr(String path, String name) throws FuseException;
}
